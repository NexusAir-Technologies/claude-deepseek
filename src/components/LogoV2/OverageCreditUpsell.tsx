  ...
  if ($[0] !== maxWidth || $[1] !== twoLine) {
    ...
    bb0: {
      ...
      if (twoLine) {
        ...
        t2 = <><Text color="permission">{maxWidth ? truncate(title, maxWidth) : title}</Text>{t4}</>;
        break bb0;
      }
      ...
      t1 = <Text dimColor={true}><Text color="permission">{display.slice(0, highlightLen)}</Text>{display.slice(highlightLen)}</Text>;
    }
    $[0] = maxWidth;
    $[1] = twoLine;
    $[2] = t1;
